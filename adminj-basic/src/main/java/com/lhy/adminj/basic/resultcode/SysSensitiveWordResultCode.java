 ...
 */
public enum SysSensitiveWordResultCode implements ResultCode {
   ...
   /** 成功 */
    ...
    /** 敏感词已经存在 **/
    SENSITIVEWORD_EXISTS(50001,"SENSITIVEWORD_EXISTS"),
    ...
    SysSensitiveWordResultCode(int statusCode, String errorCode) {
