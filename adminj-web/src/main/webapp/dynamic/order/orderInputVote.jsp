...
<body class="easyui-layout" style="overflow-y: hidden"  scroll="no">
    ...
    <div class="bg1">
        <div>
            <div>
                <label>用户姓名：</label><input name="userName" value="${voteGroupUser.userName }" disabled/>
                <label>跟投组合：</label><input name="groupName" value="${voteGroup.groupName}" disabled/>
                <label>跟投用户：</label><input name="voteName" value="${user.userName }" disabled/>
            </div>
        </div>
        <div>
        ...
        <div id="inputTradeView">
            <form id="inputTradeForm" method="post" action="${ctx }/dynamic/orderInput.json">
                ...
                <input type="hidden" name="parentGroupId" value="${voteGroup.groupId}" />
                ...
                <div class="easyui-panel" title="录入交易记录" style="padding:7px 10px; margin-bottom: 10px;">
                    <table>
                        ...
                        <c:forEach items="${voteGroupDetails }" var="stock">
                        <tr>
                            <td><input class="easyui-textbox" type="text" name="stockCode" value="${stock.stockCode }" data-options="editable:false,required:true,width:100"/>
                            </td>
                            <td><input class="easyui-textbox" type="text" name="stockName" value="${stock.stockName }" data-options="editable:false,required:true,width:100"/>
                            </td>
                            <td><input class="easyui-numberbox" type="text" name="num" value="0" data-options="required:true,width:100,formatter:function(value,row,index){return parseInt(value/100)*100;}"/></td>
                            <td>
                            ...
                            <td><input class="easyui-numberbox" precision="2" value="${stock.zxz }" type="text" name="tradePrice" data-options="required:true,width:100"/>
                            </td>
                        </tr>
                        </c:forEach>
                        </tbody>
            ...
            <div class="easyui-panel" title="录入持仓" style="padding:7px 10px; margin-bottom: 10px;">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><input class="easyui-textbox" type="text" name="stockName"  value="${stock.stockName}"
